...
def main() -> None:
    ...
    merged_practive_crosstab_data = processing.merge_mapping_and_practice_data(mapping_data=mapping_data, practice_data=tidy_practice_crosstab_data)

    print(merged_practive_crosstab_data.info())
